...
public class UIConstants {
    ...
    public static final Color PRIMARY_DARK      = new Color(0,   86,  179);  // #0056B3 hover/pressed
    public static final Color PRIMARY_LIGHT     = new Color(0,   105, 217);  // #0069D9 accent
    public static final Color PRIMARY_BG_SOFT   = new Color(232, 240, 254);  // #E8F0FE nền xanh nhạt
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    //  SIDEBAR — Light theme (Trắng / Xám xanh nhạt)
    // ═══════════════════════════════════════════════════════════════════════════
    public static final Color SIDEBAR_BG            = new Color(255, 255, 255); // #FFFFFF
    public static final Color SIDEBAR_HEADER_BG     = new Color(0,   123, 255); // #007BFF  header xanh
    public static final Color SIDEBAR_ITEM_HOVER    = new Color(232, 240, 254); // #E8F0FE
    public static final Color SIDEBAR_ACTIVE        = PRIMARY;
    public static final Color SIDEBAR_TEXT          = new Color(51,  51,  51);  // #333333 đen xám đậm
    public static final Color SIDEBAR_TEXT_ACTIVE   = new Color(0,   123, 255); // #007BFF xanh chủ đạo

    // Sidebar button states
    public static final Color SIDEBAR_BTN_DEFAULT   = new Color(255, 255, 255); // #FFFFFF trắng
    public static final Color SIDEBAR_BTN_HOVER     = new Color(232, 240, 254); // #E8F0FE xanh nhạt
    public static final Color SIDEBAR_BTN_ACTIVE    = new Color(232, 240, 254); // #E8F0FE nền active
    public static final Color SIDEBAR_SEPARATOR     = new Color(226, 232, 240); // #E2E8F0
    public static final Color SIDEBAR_SECTION_TEXT   = new Color(0,   86,  179); // #0056B3 xanh đậm cho tiêu đề nhóm
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    public static final Color LOGOUT_COLOR      = new Color(0,   123, 255);  // #007BFF primary
    public static final Color LOGOUT_HOVER      = new Color(0,   86,  179);  // #0056B3 primary dark
    ...
    // Tiêu đề & nội dung  (×1.2 so với bản gốc)
