...
/**
 * Frame chính dành cho Admin.
 * Admin main frame — displayed after successful login with ADMIN role.
 */
public class AdminFrame extends JFrame {

    private static final Color BG_COLOR      = new Color(0x1A1A2E);
    private static final Color CARD_BG       = new Color(0x16213E);
    private static final Color ACCENT_COLOR  = new Color(0x0F3460);
    private static final Color PRIMARY_COLOR = new Color(0xE94560);
    ...
    private void initComponents() {
        ...
        // ── Title ─────────────────────────────────────────────
        JLabel title = new JLabel("Quản trị viên");
